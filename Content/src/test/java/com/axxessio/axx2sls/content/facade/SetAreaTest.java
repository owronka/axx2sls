...
public class SetAreaTest {
    ...
    public void testSetArea() {
        ...
        try {
        	FileInputStream fis = new FileInputStream("./src/test/resources/InsertAreaEvent.json");
        	...
        	fis = new FileInputStream("./src/test/resources/UpdateAreaEvent.json");
